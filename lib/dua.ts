...
const TEMPLATES: Record<Target, Record<Intention, DuaText[]>> = {
  ...
  ANONIM: {
    HUZUR: [
      { line1: "Allah’ım, bir kulunun kalbine huzur indir; yolunu aydınlat." },
      { line1: "Ya Rabbi, adını bilmediğim bir kalbe sükunet ver." },
      { line1: "Allah’ım, bir kulunu gamdan uzaklaştır.", line2: "Kalbine esenlik nasip et." },
      { line1: "Allah’ım, bir kalbin içine dinginlik ver; gecesini selametle geçir." },
    ],
    FERAHLIK: [
      { line1: "Allah’ım, bir kulunun gönlünü ferahlat; sıkıntısını hafiflet." },
      { line1: "Ya Rabbi, adını bilmediğim bir kalbe iç genişliği nasip et." },
      { line1: "Allah’ım, bir kulunun yükünü azalt.", line2: "Gönlüne rahatlık ver." },
      { line1: "Allah’ım, bir kalbe ferah bir nefes değdir; darını aç." },
    ],
    KOLAYLIK: [
      { line1: "Allah’ım, bir kulunun işlerini kolaylaştır; hayırlı kapılar aç." },
      { line1: "Ya Rabbi, adını bilmediğim birine kolaylık lutfet." },
      { line1: "Allah’ım, bir kulunun önündeki zorluğu hafiflet.", line2: "Yolunu hayırla aç." },
      { line1: "Allah’ım, bir kalbin yükünü azalt; işini kolay eyle." },
    ],
    CESARET: [
      { line1: "Allah’ım, bir kuluna metanet ver; onu şerden muhafaza eyle." },
      { line1: "Ya Rabbi, adını bilmediğim bir kalbe sebat nasip et." },
      { line1: "Allah’ım, bir kulunun korkusunu azalt.", line2: "Ona hayırlı cesaret ver." },
      { line1: "Allah’ım, bir kalbi güvenle doldur; zor anda dayanma gücü ver." },
    ],
  },
};
